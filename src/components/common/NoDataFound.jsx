...
const NoDataFound = () => {
  return (
    <>
      <div class="w-full flex items-center flex-wrap justify-center gap-10 mx-auto">
        <div class="grid gap-4 ">
          ...
          <div>
            <h2 class="text-center text-white text-2xl font-semibold leading-relaxed pb-1 kanit-semibold">
              There’s no link here
            </h2>
            <p class="text-center text-gray-400 text-sm kanit-regular">
              You can create a link to your favorite website
            </p>
          </div>
        </div>
      </div>
